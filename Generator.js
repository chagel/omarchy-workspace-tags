...
function render(settings) {
  ...
  lines.push("")
  lines.push("-- Nothing here tracks a previous tag. dwm reaches the one you came from with")
  lines.push("-- MOD+Tab, and Omarchy already binds SUPER + CTRL + TAB to the same idea, so")
  lines.push("-- that key is left alone rather than reimplemented per monitor. Its \"previous\"")
  lines.push("-- is Hyprland's and therefore global: use it across monitors and it can land")
  lines.push("-- you on the other screen.")
  ...
  lines.push("")
  lines.push("  -- Asking for the tag you are already on does nothing, the way dwm's view")
  lines.push("  -- returns early on it.")
